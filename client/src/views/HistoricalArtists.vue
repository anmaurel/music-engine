<template>
    <div id="main" class="devices">
        <h1 class="title is-size-1">Historical artist data</h1>
        <p class="subtitle has-text-weight-light">Number of followers of some artists retrieved from Spotify api and stored on our own database given each day (cron job). The left graph evolves according to hover data on the right graph and by clicking on the name of an artist you can remove it from the two graphics below.</p>
        <ECharts
            v-if="ready"
            ref="chart"
            :option="options"
            ...
            options: markRaw({
                ...
                dataset: {
                    source: [
                        ...
                        // ['JSX', 5423, 5447, 5469],
                        ['artist', '21/07', '22/07', '23/07', '24/07', '25/07', '26/07', '27/07', '28/07', '29/07', '30/07', '31/07', '01/08', '02/08', '03/08', '04/08', '05/08', '06/08', '07/08', '08/08', '09/08', '10/08', '11/08', '12/08', '13/08', '14/08', '15/08', '16/08', '17/08', '18/08', '19/08'],
                        ['Booba'],
    ...
    methods: {
        getUpdatedData() {
            ...
            for (let i = 1; i <= 6; i++) {
                ...
                let res = gData.filter((element) => element.artistId === '' + i + '');
